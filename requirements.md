...
**User Story 1: View device visualizations (Prio “Could”)**
...
**User Story 2: View device data in table form (Prio “Must”)**
...
- Each row includes at least: manufacturer, device name, release year, screen size, resolution and pixel density.
...
As an unauthorized user, I want to suggest a new device, so that missing historical or new data can be added.
